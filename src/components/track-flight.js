        ...
        <div class="track_flight">
            <div class="track-flight-container">
                ...
                <div class="custom_wrapper_left">
                    ...
                    <div class="custom_city_details">
                        <div class="custom_section_first">
                            <div class="one_third">
                                <h4>Paris, Europe</h4>
                                <h5>take off from</h5>
                                <h3>CDG, Charles de Gaulle</h3>
                            </div>
                            <div class="one_third time">
                        ...
                        <div class="custom_destination">
                            <img src="images/destination.png" class="img-responsive" />
                        </div>
    
                        <div class="custom_section_second">
                            <div class="one_second">
                                <h4>TUESDAY 23/02/2018</h4>
                                <h3>10.40 AM <span>(10 minutes early)</span></h3>
                            </div>
                            <div class="one_second text-right">
                                <h4>TUESDAY 23/02/2018</h4>
                ...
                <div class="custom_wrapper_right">
                    <div class="city_title">
                        <div class="content">
                            <div class="title_left"><p>+17</p><p>c</p></div>

                            <div class="title_right"><i class="fa fa-heart-o"></i></div>
                            <h1>SAN FRANCISCO <span>California, USA</span></h1>
                            <p>QA762</p>
                        </div>
                        <img src="images/track-flight.png" class="img-responsive" />
                    </div>
                    <div>
                        
                        <div class="rought_time">
                            <div class="flight_time clearfix">
                                <div class="flight_data">
                                    Flight Data<br/>
                                    Speed: <b>888km/h</b>
                                </div>
                                <div class="flight_desciption">
                                    <p><a href="#">Airbus</a></p>
                            ...
                            <div class="custom_schedule">   
                                <h5 class="departure">Departure times <span></span></h5>
                                <div class="width-50">
                                    <p>Actual</p>
                                    <b>10.30 AM</b>
                                </div>
                            ...
                            <div class="custom_schedule">   
                                <h5 class="arrival">Arrival times <span></span></h5>
                                <div class="width-50">
                                    <p>Estimated</p>
                                    <b>11.22 PM</b>
                                </div>
                            ...
                            <div class="custom_schedule">   
                                <h5>Airline</h5>
                                <div class="width-100 flight-name">
                                    <p>Qatar Airways</p>
