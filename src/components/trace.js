...
class Trace extends Component {
	render() {
        ...
        <div class="container-fluid">
            <Header />
            <div class="banner banner-trace banner-small no-text-banner">
        ...
        <div class="">
            <div class="card-layout-1 text-center card-map-container card-margin-style-1 no-padding"  >
                <div class="map" styles="min-height: 300px;">
